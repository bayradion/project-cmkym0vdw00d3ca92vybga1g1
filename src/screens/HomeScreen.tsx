...
const ContactItem = React.memo<ContactItemProps>(({ item, onPress, getLastMessage, formatTime }) => {
  const lastMessage = useMemo(() => getLastMessage(item.id), [item.id, getLastMessage]);
...
const HomeScreen: React.FC = () => {
  ...
  }, [handleContactPress, getLastMessage, formatTime]);
